...
int main()
{
    ...
    char nombre[31],path_txt[35],path_bin[35],path_idx[35];
    ...
    printf("\n ************************************");
    printf("\n * GENERACIÓN DE ARCHIVO DE ALUMNOS * \a\a");
    printf("\n ************************************ \n\n");
    ...
    printf("\n\n Ingrese el nombre del archivo de texto (NO el path. Nombre SIN extensión): \n\n\t\a\a");
    fflush(stdin);
    gets(nombre);

    //genero los paths de los archivos de lectura, escritura e índice, a partir del nombre del archivo

    str_cat(str_cpy(path_txt,nombre),".txt");
    str_cat(str_cpy(path_bin,nombre),".dat");
    str_cat(str_cpy(path_idx,nombre),".idx");
    ...
    //el archivo del índice se abre en la primitiva grabar en indice
    ...
    generar_archivo_de_alumnos(pf_lectura,pf_escritura,pf_errores,&fecha_proceso,path_idx);
